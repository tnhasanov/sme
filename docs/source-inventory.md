...
| **`Rəy [BORROWER] İH 550.000 AZN.xlsx`** *(the completed opinion workbook — it physically lives in archive 2; noted here because it is the executable form of this methodology)* | — | — | see archive 2 | — | — |
